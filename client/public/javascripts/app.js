 ...
 */
var Track, TrackListView, TrackView, ViewCollection,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
buf.push("<a href=\"#\" title=\"go to your songs\"><div id=\"top-nav-title-home\" class=\"top-nav-title\"><span class=\"top-nav-text\">COZIC&nbsp;</span><i class=\"icon-home\"></i></div></a><a href=\"#playqueue\" title=\"go to the play queue\"><div id=\"top-nav-title-list\" class=\"top-nav-title\"><span class=\"top-nav-text\">Up Next&nbsp;</span><i class=\"icon-list\"></i></div></a><div id=\"upload-form\" title=\"click to add tracks\" class=\"top-nav-title\"><span class=\"top-nav-text\">Upload&nbsp;</span><i class=\"icon-cloud-upload\"></i></div><div id=\"youtube-import\" title=\"import sounds from Youtube\" class=\"top-nav-title\"><span class=\"top-nav-text\">Youtube&nbsp;</span><i class=\"icon-youtube\"></i></div><div id=\"broadcast\" title=\"broadcast your cozic\" class=\"top-nav-title\"><span class=\"top-nav-text\">Broadcast&nbsp;</span><i class=\"icon-rss\"></i></div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
